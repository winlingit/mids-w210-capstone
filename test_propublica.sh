...
curl "https://api.propublica.org/congress/v1/115/senate/members.json" -H "X-API-Key: ${KEY}" > members_senate.json
curl "https://api.propublica.org/congress/v1/115/house/members.json" -H "X-API-Key: ${KEY}" > members_house.json
...
curl "https://api.propublica.org/congress/v1/115/senate/members/leaving.json" -H "X-API-Key: ${KEY}" > leaving_senate.json
curl "https://api.propublica.org/congress/v1/115/house/members/leaving.json" -H "X-API-Key: ${KEY}" > leaving_house.json
